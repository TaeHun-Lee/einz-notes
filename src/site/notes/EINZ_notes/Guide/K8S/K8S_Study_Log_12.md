---
{"dg-publish":true,"permalink":"/einz-notes/guide/k8-s/k8-s-study-log-12/","title":"12: cert-manager"}
---


# HTTPS 인증서 자동화 구축 (cert-manager)

Kubernetes 환경에서 HTTPS 통신을 위한 TLS 인증서 발급 및 갱신을 자동화하는 과정이다. 로컬 가상 환경 특성상 외부 공인 인증 기관을 거칠 수 없으므로 자체 서명(Self-Signed) 방식을 사용했다.
