---
{"dg-publish":true,"permalink":"/einz-notes/guide/k8s/k8s-study-log-11/","title":"11: 통합 모니터링 시스템 구축: Prometheus, Grafana, Loki"}
---


# 통합 모니터링 시스템 구축: Prometheus, Grafana, Loki

Kubernetes 클러스터의 시스템 자원 메트릭과 파드(Pod) 로그를 중앙에서 수집하고 시각화하는 통합 모니터링 파이프라인 구축 과정 요약.
